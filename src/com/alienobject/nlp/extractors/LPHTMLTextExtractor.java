...
import com.alienobject.nlp.extractors.html.StripHTML;
...
public class LPHTMLTextExtractor {
    static File modelFile = null;
    static Classifier classifier;

    public LPHTMLTextExtractor() {
        try {
            init();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void dbg(String s) {
        System.out.println("LPHTMLTextExtractor: " + s);
    }

    public static String extract(String text) throws Exception {
        LPHTMLTextExtractor qe = new LPHTMLTextExtractor();
        return qe.extractText(text);
    }
